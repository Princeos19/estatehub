        ...
        <div className="bg-white rounded-2xl shadow-card p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              ...
              <input type="email" required autoFocus placeholder="you@email.com" className="input-field" value={form.email} onChange={set('email')} />
            </div>
            <div>
              <label className="block text-xs font-semibold text-brand-text-2 mb-1.5">Password</label>
              <div className="relative">
                <input type={showPassword ? 'text' : 'password'} required placeholder="Your password" className="input-field pr-10" value={form.password} onChange={set('password')} />
